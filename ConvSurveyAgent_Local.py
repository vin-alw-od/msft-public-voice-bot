...
class SurveyAgent:
    def __init__(self):
        ...
        with open("/Users/aadhavarjun/workspace/github_code/msft-public-voice-bot/Test_Context_HPE.csv", newline="") as csvfile:
        ...
        self.slots = []
        self.definitions = {}
        with open("/Users/aadhavarjun/workspace/github_code/msft-public-voice-bot/Test_Slots.csv", newline="") as csvfile:
            reader = csv.DictReader(csvfile)
            for row in reader:
    ...
    def load_previous_initiatives(self):
        ...
        try:
            filename = "/Users/aadhavarjun/workspace/github_code/msft-public-voice-bot/AI_Initiatives.csv"
            if os.path.exists(filename):
                df = pd.read_csv(filename)
